...
const (
	...
	// INODE_DIRECT_BLOCKS_INDEX is a range of 0...11
	INODE_DIRECT_BLOCKS_INDEX = 12

	// INODE_INDIRECT_BLOCK_INDEX is the index number within the Data Blocks table. It points to the Dentry to load for find the next set of Data Blocks
	INODE_INDIRECT_BLOCK_INDEX = 12

	// INODE_DOUBLE_INDIRECT_BLOCK_INDEX is the index number within the Data Blocks table. These are doubly nested Data Blocks.
	INODE_DOUBLE_INDIRECT_BLOCK_INDEX = 13

	// INODE_TRIPLE_INDIRECT_BLOCK_INDEX is the index number within the Data Blocks table. These are triple nested Data Blocks.
	INODE_TRIPLE_INDIRECT_BLOCK_INDEX = 14
